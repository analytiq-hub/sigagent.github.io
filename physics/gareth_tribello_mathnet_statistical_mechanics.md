...
* When the hamiltonian breaks into a sum of terms with independent variables $$H(x_1, x_2, x_3, x_4) = H_1(x_1)+H_2(x_2)+H_3(x_3,x_4)$$, we've seen that the partition function breaks into a product of partition functions $$Z={\int e^{-\beta H_1(x_1)} \mathrm{d}x_1} {\int e^{-\beta H_2(x_2)} \mathrm{d}x_2} \int e^{-\beta H_3(x_3,x_4)} \mathrm{d}x_3 \mathrm{d}x_4={\color{red} Z_1}{Z_2}Z_3$$
