...
* Solids are molecules in a lattice. Each atom is an oscillator. The energy of the oscillation determines the specific heat of the crystal. This heat capacity was estimated by classical physics to be much much larger than observed. It was Einstein who figured out that the quantum nature of the oscillators suppressed the oscillators until the temperature got high enough. This is one of Einstein's small minor contributions.
