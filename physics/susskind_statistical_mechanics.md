...
* What is pressure, really? With a cilinder and piston, if pressure moves the piston of area $$A$$ by an amount $$\Delta x$$, then the change in energy $$\mathrm{d}E = pA \Delta x$$
