...
A key point to note is that after the measurement, no matter what the outcome, α and β are gone. No matter whether the posterior state is ∣0⟩∣0⟩ or ∣1⟩∣1⟩, there is no trace of αα or ββ. And so you can’t get any more information about them. In that sense, αα and ββ are a kind of hidden information – the measurement doesn’t tell you what they were.*
