...
A sequence $$(x_n)_{n >= 0}$$ converges $$\underline{n \rightarrow \infty}{lim \, x_n} = x$$ if for any $$\eps > 0$$ there exists $$n_0$$ such that for any $$n \ge n_0$$ we have $$x - \eps < x_n < x + \eps$$.