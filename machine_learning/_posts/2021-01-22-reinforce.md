...
In machine learning, typically, what is learned is data - for example text, speech or images. *Reinforced learning* is a special case of machine learning where what is learned are *processes*, using a *reward* function to determie the optimal state.
