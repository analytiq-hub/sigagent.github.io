...
We denote $$V_\star(s)=V_\pi(s)$$ and $$Q_\star(s, a)=Q_\pi(s, a)$$ for this optimal policy $$\pi$$. The maximal policy satisfies $$V_\star(s) = \underset{a}{max}Q_\star(s, a)$$. The Bellman equations gives us the following:
