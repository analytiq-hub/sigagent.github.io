...
* Leonard Susskind: [All Stanford physics lectures in order](https://www.youtube.com/playlist?list=PL6i60qoDQhQGaGbbg-4aSwXJvxOqO6o5e)
  * Modern Physics: Classical Mechanics
    ...
    * [Lecture 9](https://www.youtube.com/watch?v=WJn6h-6MMa8&list=PL47F408D36D4CF129&index=9) Gradient, curl, divergence. Divergence of curl is zero. Fields with zero divergence are curls. Curl of gradient is zero. Fields with zero curl are gradients. Electrostatic field. Magnetic field $$\vec{B}$$. Zero divergence of magnetic field. Vector potential $$\vec{A}$$ defined so its curl is $$\vec{B}$$. Non-uniqueness of $$\vec{A}$$, up to gauge transformation $$\vec{A} + grad(f)$$. Origin of term gauge as historical glitch. Lorenz force $$\vec{F} = e (-\vec{\nabla}V + \frac{\vec{v}}{c} \times \vec{B})$$. Hamiltonian for Lorenz force. Gauge invariance of least action of the Hamiltonian.
