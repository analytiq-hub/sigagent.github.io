...
Or, even more generally, if $$a_1, ... a_n$$ are nonnegative integers, we can define
...
* $$H'(a_1, ..., a_n) = H'(a_1, ..., a_{n-2}, a_{n-1} + a_n) + (a_{n-1} + a_n) H'(\frac{a_{n-1}}{a_{n-1} + a_n}, \frac{a_{n}}{a_{n-1} + a_n})$$