...
We can reason by analogy with thermodynamics, see [Mallick]((http://www.bourbaphy.fr/mallick.pdf)), where entropy of a microcanonical system enumerates the total number of microscopic states, $$\Omega(E, V)$$, and the Bolzmann formula states that entropy is
$$
\begin{align*}
